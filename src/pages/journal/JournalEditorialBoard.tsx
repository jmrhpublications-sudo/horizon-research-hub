...
const JournalEditorialBoard = memo(() => {
  ...
  const boardMembers = [
    ...
    { name: "Dr. Dency Mary", position: "Assistant Professor", department: "Department of BBA (IB)", institution: "Nilgiri College of Arts and Science (Autonomous), Thaloor", address: "The Nilgiris – 643240, Tamil Nadu, India", email: "dencymary@nilgiricollege.ac.in", profile: "", image: "/images/editorial-board/dr-dency-mary.jpeg" },
    { name: "Dr. K Thamarai Selvi", position: "Research Coordinator & Assistant Professor", department: "Department of Commerce", institution: "Nilgiri College of Arts and Science (Autonomous)", address: "Konnachal Post, Thaloor, The Nilgiris, Tamil Nadu - 643239", email: "thamaraiselvi@nilgiricollege.ac.in", profile: "", image: "/images/editorial-board/dr-thamarai-selvi.jpeg" },
